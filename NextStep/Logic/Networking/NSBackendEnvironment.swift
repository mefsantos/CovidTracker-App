...
//            baseURLString = "https://next-step.io/"
            baseURLString = "https://covidtracker.adyta.pt"
        case .prod:
            baseURLString = "https://covidtracker.adyta.pt"
        }
        debugPrint("Returning localized baseURL: \(URL(string: baseURLString)!.appendingPathComponent("language_key".ub_localized))")
...
//            baseURLString = "https://ws-app-prod.next-step.io"
        ...
        debugPrint("Returning baseURL \(URL(string: baseURLString)!)")
